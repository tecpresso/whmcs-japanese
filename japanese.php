...
Translated: */
$_LANG['domainavailable1'] = "おめでとうございます！";
...
Translated: */
$_LANG['domainbulksearchintro'] = " ドメイン名の検索では、一度に最大20のドメインを検索できます。 下のフィールドに1行に1つずつドメインを入力します。ドメイン名の前に「www」や「http://」は入力しないでください。";
...
Translated: */
$_LANG['domainbulktransferdescription'] = "お持ちのドメインは今すぐこちらに移管することができます。 開始するには、以下へドメインを1行に1つずつ入力します。「www」や「http://」は入れないでください。";
...
Translated: */
$_LANG['domaindnsmanagement'] = "DNSの管理";
...
Translated: */
$_LANG['domainemailforwardingdesc'] = "転送先アドレスが見つからなかった場合、転送レコードは自動で無効になります。 転送先アドレスを確認してから、再度その設定を有効にしてください。 既存の転送レコードの変更は、反映に最大1時間程かかる場合があります。";

/* Original: 
$_LANG['domainemailforwardingforwardto'] = "Forward To";
Translated: */
$_LANG['domainemailforwardingforwardto'] = "へ転送";
...
Translated: */
$_LANG['domainerror'] = "ドメインレジストリに接続する際に問題が発生しました。 後程もう一度お試しください。";
...
Translated: */
$_LANG['domainerrortoolong'] = "入力したドメインが長すぎます。 ドメインの長さは最大67文字です。";
...
Translated: */
$_LANG['domaingeteppcodeemailconfirmation'] = "EPPコードリクエストが申請されました！ ドメインの登録メールアドレスへ送信されました";
...
Translated: */
$_LANG['domaingeteppcodeexplanation'] = "EPPコードは基本的にはドメイン名のパスワードのようなものです。 ドメイン名の所有者だけがドメイン名を転送できるようにするセキュリティ対策です。 ドメインを別のレジストラに移管する場合に必要になります。";

/* Original: 
$_LANG['domaingeteppcodefailure'] = "There was an error in requesting the EPP Code:";
Translated: */
$_LANG['domaingeteppcodefailure'] = "EPPコードを要求する際にエラーが発生しました：";

/* Original: 
$_LANG['domaingeteppcodeis'] = "The EPP Code for your domain is:";
Translated: */
$_LANG['domaingeteppcodeis'] = "ドメインのEPPコードは：";
...
Translated: */
$_LANG['domainintrotext'] = "下のボックスに使用するドメインとtldを入力し[検索]をクリックし、そのドメインが購入可能か確認します。";
...
Translated: */
$_LANG['domainregisternsdelsuccess'] = "ネームサーバーは削除されました";
...
Translated: */
$_LANG['domainregisternsexplanation'] = "ここから、ドメインのカスタムネームサーバーを作成して管理することができます（例えば、NS1.example.com、NS2.example.com など）。";
...
Translated: */
$_LANG['domainregistrantchoose'] = "連絡先を選択してください";
...
Translated: */
$_LANG['domainregistrarlockdesc'] = "レジストラロックを有効にする（推奨）。 ロックが設定されていると、不正な転送が防止されます。";
...
Translated: */
$_LANG['domainsautorenewdisabledwarning'] = "警告！ このドメインは自動更新が無効になっています。<br />手動で更新しないと、有効期限が切れ無効となります。";
...
Translated: */
$_LANG['domainsimplesearch'] = "ドメイン検索";
...
Translated: */
$_LANG['domainviewwhois'] = "whoisレポートを見る";
...
Translated: */
$_LANG['downloadpurchaserequired'] = "アクセスが拒否されました - ダウンロードする前に関連する製品を購入する必要があります";
...
Translated: */
$_LANG['downloadsdescription'] = "ダウンロードライブラリを見る";
...
Translated: */
$_LANG['downloadsintrotext'] = "ダウンロードライブラリには、ウェブサイトを起動して実行するまでのマニュアル、プログラム、他必要なものがあります。";
...
Translated: */
$_LANG['flashtutorialsdescription'] = "コントロールパネルの使用方法を表示するには、ここをクリックしてください";
...
Translated: */
$_LANG['flashtutorialsheadertext'] = "フラッシュチュートリアルは、コントロールパネルをフル活用するのに役立ちます。 下のタスクを選択して、ステップバイステップチュートリアルで完了する方法を参照してください。";

/* Original: 
$_LANG['forwardingtogateway'] = "Please wait while you are redirected to the gateway you chose to make payment...";
Translated: */
$_LANG['forwardingtogateway'] = "お支払いをゲートウェイにリダイレクト中ですのでお待ちください...";
...
Translated: */
$_LANG['imagecheck'] = "画像に表示されているセキュリティコードを入力してください - これは自動提出を防ぐために必要です";

/* Original: 
$_LANG['invoiceaddcreditamount'] = "Enter the amount to apply";
Translated: */
$_LANG['invoiceaddcreditamount'] = "金額を入力してください";

/* Original: 
$_LANG['invoiceaddcreditapply'] = "Apply Credit";
Translated: */
$_LANG['invoiceaddcreditapply'] = "クレジットを適用する";
...
Translated: */
$_LANG['invoiceaddcreditdesc2'] = "以下のフォームを使用して請求書に適用することができます。";
...
Translated: */
$_LANG['invoiceaddcreditovercredit'] = "アカウントにある金額よりも多くのクレジットを適用することはできません";
...
Translated: */
$_LANG['invoiceofflinepaid'] = "オフラインクレジットカード決済は手作業で処理されます。<br />支払いが処理されたら、確認メールが送られます。";
...
Translated: */
$_LANG['invoiceserror'] = "エラーが発生しました。 再度お試しください。";
...
Translated: */
$_LANG['invoicesoutstandinginvoices'] = "未払請求書";
...
Translated: */
$_LANG['kbsuggestionsexplanation'] = "ナレッジベースには以下の記事があります。 まずはその記事を確認してください。";
...
Translated: */
$_LANG['knowledgebasedescription'] = "FAQへの回答はKBを参照してください";
...
Translated: */
$_LANG['knowledgebaseintrotext'] = "ナレッジベースはさまざまなカテゴリに編成されています。 下からカテゴリを選択するか、質問に対する答えをナレッジベースで検索してください。";
...
Translated: */
$_LANG['knowledgebaseratingtext'] = "ユーザが役立ったといっています";
...
Translated: */
$_LANG['loginincorrect'] = "ログインの詳細が正しくありません。 もう一度お試しください。";
...
Translated: */
$_LANG['logoutcontinuetext'] = "続けるにはこちらをクリック...";
...
Translated: */
$_LANG['maxmind_anonproxy'] = "匿名プロキシを使用して注文することはできません";
...
Translated: */
$_LANG['maxmind_callingnow'] = "あなたの電話番号に自動で電話をかけています。 これは不正詐欺対策の一環です。 注文を完了するためには、以下に入力する4桁のセキュリティコードが与えられます。";
...
Translated: */
$_LANG['maxmind_countrymismatch'] = "あなたのIPアドレスの国が、入力した請求先住所の国と一致していないため、注文を受け付けられません";
...
Translated: */
$_LANG['maxmind_faileddescription'] = "入力したコードは正しくありません。 これがエラーの場合は、早急にサポート部門にご連絡ください。";
...
Translated: */
$_LANG['maxmind_highfraudriskscore'] = "お客様の注文は手動による審査が行われています。<br /><br />このメッセージを誤って受け取ったと思われる場合は、お詫びと<a href = \"submitticket.php\">サポートチケットをカスタマーサービスに送信</a>します。ありがとうございました。";
...
Translated: */
$_LANG['maxmind_highriskcountry'] = "あなたの国からの詐欺行為がたくさんあったので、ご注文をすすめることができません。 他のお支払い方法がありましたら、ご連絡ください。";
...
Translated: */
$_LANG['maxmind_rejectemail'] = "無料のメールアドレスを使用した注文は受け付けておりません。別のメールアドレスを使用してもう一度お試しください";
...
Translated: */
$_LANG['networkissuesdescription'] = "現在および予定されているネットワーク停止について";

/* Original: 
$_LANG['networkissueslastupdated'] = "Last Updated";
Translated: */
$_LANG['networkissueslastupdated'] = "最終更新";
...
Translated: */
$_LANG['networkissuesprioritycritical'] = "クリティカル";
...
Translated: */
$_LANG['orderadditionalrequiredinfo'] = "必要な追加情報";
...
Translated: */
$_LANG['orderaddondescription'] = "この製品には以下のアドオンがあります。 注文したいアドオンを選択してください。";
...
Translated: */
$_LANG['orderchangeaddons'] = "アドオンを変更";
...
Translated: */
$_LANG['orderchangedomain'] = "ドメインを変更";

/* Original: 
$_LANG['orderchangenameservers'] = "Change Nameservers Only";
Translated: */
$_LANG['orderchangenameservers'] = "ネームサーバーのみを変更する";

/* Original: 
$_LANG['orderchangeproduct'] = "Change Product";
Translated: */
$_LANG['orderchangeproduct'] = "サービスを変更する";
...
Translated: */
$_LANG['ordercompletebutnotpaid'] = "注意！ ご注文は完了しましたが、まだお支払いを行っていないため有効になりません。<br />下のリンクをクリックして請求書に移動してお支払いください。";
...
Translated: */
$_LANG['orderconfirmorder'] = "注文を確認する";

/* Original: 
$_LANG['ordercontinuebutton'] = "Click to Continue >>";
Translated: */
$_LANG['ordercontinuebutton'] = "続けるにはクリックしてください >>";
...
Translated: */
$_LANG['orderdescription'] = "新しい注文をする";

/* Original: 
$_LANG['orderdiscount'] = "Discount";
Translated: */
$_LANG['orderdiscount'] = "ディスカウント";
...
Translated: */
$_LANG['orderdomainoption1part1'] = "が欲しいです";
...
Translated: */
$_LANG['orderdomainoption2'] = "既存のドメインのネームサーバーを更新するか、または新しいドメインを登録します。";

/* Original: 
$_LANG['orderdomainoption3'] = "I want to transfer my domain to";
Translated: */
$_LANG['orderdomainoption3'] = "へドメインをに移行したい";

/* Original: 
$_LANG['orderdomainoption4'] = "I want to use a free subdomain.";
Translated: */
$_LANG['orderdomainoption4'] = "無料のサブドメインを使いたい。";
...
Translated: */
$_LANG['ordererroraccepttos'] = "利用規約に同意しなければなりません";
...
Translated: */
$_LANG['ordererrordomainalreadyexists'] = "入力したドメインは既に登録されています - 新しい注文をする前にキャンセルください。";
...
Translated: */
$_LANG['ordererrorservernohostname'] = "サーバーのホスト名を入力してください";

/* Original: 
$_LANG['ordererrorservernonameservers'] = "You must enter a prefix for both nameservers";
Translated: */
$_LANG['ordererrorservernonameservers'] = "両方のネームサーバーにはプレフィックスを入力する必要があります";

/* Original: 
$_LANG['ordererrorservernorootpw'] = "You must enter your desired root password";
Translated: */
$_LANG['ordererrorservernorootpw'] = "ご希望のrootパスワードを入力してください";
...
Translated: */
$_LANG['ordererrortransfersecret'] = "トランスファーシークレットを入力してください";
...
Translated: */
$_LANG['orderexistinguser'] = "私は既存の客で、この注文をアカウントに追加したいです";

/* Original: 
$_LANG['orderfailed'] = "Order Failed";
Translated: */
$_LANG['orderfailed'] = "注文失敗";
...
Translated: */
$_LANG['orderinvalidcodeforbillingcycle'] = "このコードは選択した請求サイクルには適用されません";
...
Translated: */
$_LANG['ordernewuser'] = "私は新規の客で、アカウントを作成したいです。";
...
Translated: */
$_LANG['orderpaymenttermbiennially'] = "一年おき（隔年）";
...
Translated: */
$_LANG['orderreceived'] = "注文いただきありがとうございます。 間もなく確認メールが届きます。";
...
Translated: */
$_LANG['orderserverhostname'] = "サーバのホスト名";

/* Original: 
$_LANG['orderservernameservers'] = "Nameservers";
Translated: */
$_LANG['orderservernameservers'] = "ネームサーバ";
...
Translated: */
$_LANG['orderservernameserversdescription'] = "ここに入力したプレフィックス(接頭辞)によって、サーバのデフォルトネームサーバが決まります。 例: ns1.example.comとns2.example.com";

/* Original: 
$_LANG['orderservernameserversprefix1'] = "Prefix 1";
Translated: */
$_LANG['orderservernameserversprefix1'] = "プレフィックス 1";

/* Original: 
$_LANG['orderservernameserversprefix2'] = "Prefix 2";
Translated: */
$_LANG['orderservernameserversprefix2'] = "プレフィックス 2";
...
Translated: */
$_LANG['ordertotalrecurring'] = "定期的な合計";
...
Translated: */
$_LANG['ordertransfersecret'] = "移管シークレット";
...
Translated: */
$_LANG['orderusesubdomain'] = "サブドメインを使用";
...
Translated: */
$_LANG['outofstockdescription'] = "現在この商品は在庫切れのため、入荷するまで注文ができません。 詳しくはお問い合わせください。";
...
Translated: */
$_LANG['presalescontactdescription'] = "プリセールスに関するお問い合わせはこちら";
...
Translated: */
$_LANG['registerdomaindesc'] = "利用可能かを確認するには、以下に登録するドメインを入力してください。";
...
Translated: */
$_LANG['serverchangepasswordfailed'] = "パスワード変更に失敗しました！";

/* Original: 
$_LANG['serverchangepasswordsuccessful'] = "Password Changed Successfully!";
Translated: */
$_LANG['serverchangepasswordsuccessful'] = "パスワードは正常に変更されました！";
...
Translated: */
$_LANG['serverlogindetails'] = "ログインの詳細";

/* Original: 
$_LANG['servername'] = "Server Name";
Translated: */
$_LANG['servername'] = "サーバ名";
...
Translated: */
$_LANG['serverrootpw'] = "ルートのパスワード";

/* Original: 
$_LANG['serverstatusdescription'] = "View live status info for our servers";
Translated: */
$_LANG['serverstatusdescription'] = "サーバーのライブステータス情報を見る";
...
Translated: */
$_LANG['serverstatusphpinfo'] = "PHP 情報";
...
Translated: */
$_LANG['ssladmininfodetails'] = "以下の連絡先情報は証明書には表示されません - この注文に関してあなたにご連絡するためにのみ使用されます。 SSL証明書と今後の更新通知は、下記に指定されたEメールアドレスに送信されます。";

/* Original: 
$_LANG['sslcertapproveremail'] = "Certificate Approver Email";
Translated: */
$_LANG['sslcertapproveremail'] = "証明書承認者のEメール";
...
Translated: */
$_LANG['sslcertapproveremaildetails'] = "この証明書の承認Eメールが必要な場合は、以下のオプションから選択できます。";
...
Translated: */
$_LANG['pleasechooseone'] = "一つ選んでください...";
...
Translated: */
$_LANG['sslconfigcompletedetails'] = "これでSSL証明書の設定は完了し、検証のために認証局に送信されました。 承認するためのEメールがまもなく送られてきます。";

/* Original: 
$_LANG['sslconfsslcertificate'] = "Configure SSL Certificate";
Translated: */
$_LANG['sslconfsslcertificate'] = "SSL証明書を設定する";
...
Translated: */
$_LANG['sslserverinfodetails'] = "SSL証明書を設定するには、有効な\"CSR\"（証明書署名要求）が必要です。 CSRはSSL証明書をインストールするWebサーバーで生成された暗号化されたテキストです。 まだCSRを持っていないならば生成するか、CSRを生成するようにウェブホスティングプロバイダーに依頼してください。";

/* Original: 
$_LANG['sslservertype'] = "Web Server Type";
Translated: */
$_LANG['sslservertype'] = "Webサーバーの種類";
...
Translated: */
$_LANG['statsdueinvoicesbalance'] = "請求書残高の期日";
...
Translated: */
$_LANG['supportticketsheader'] = "ナレッジベースで問題の解決策が見つからない場合は、下の該当する部門を選択してチケットを送信してください。";
...
Translated: */
$_LANG['supportticketsopentickets'] = "サポートチケットをオープンする";
...
Translated: */
$_LANG['supportticketsposted'] = "投稿しました";
...
Translated: */
$_LANG['supportticketssystemdescription'] = "サポートチケットシステムを使っていただくことにより、私たちはお客様からの問題や質問にできるだけ迅速に対応することができます。 私たちがサポートチケットに返信すると、電子メールでお客様へ通知されます。";
...
Translated: */
$_LANG['supportticketsuploadtoolarge'] = "アップロードしたファイルが大きすぎます。 小さいファイルをアップロードしてください。";
...
Translated: */
$_LANG['supportticketclosedmsg'] = "このチケットはクローズされました。 このチケットに返信して再度オープンすることができます。";

/* Original: 
$_LANG['telesignincorrectpin'] = "Incorrect Pin!";
Translated: */
$_LANG['telesignincorrectpin'] = "Pinが間違っています！";

/* Original: 
$_LANG['telesigninitiatephone'] = "We can't initiate phone verification for your number. Please contact us.";
Translated: */
$_LANG['telesigninitiatephone'] = "あなたの番号の電話確認を開始することはできません。 お問い合わせください。";
...
Translated: */
$_LANG['telesignsmstextmessage'] = "SMS確認システムをご利用いただきありがとうございます。 あなたのコードは: %s です。今すぐあなたのコンピュータにこのコードを入力してください。";

/* Original: 
$_LANG['telesigntitle'] = "TeleSign phone verification.";
Translated: */
$_LANG['telesigntitle'] = "テレサイン電話検証";

/* Original: 
$_LANG['telesigntype'] = "Choose verification type for number %s:";
Translated: */
$_LANG['telesigntype'] = "番号 %s: の確認タイプを選択してください。";
...
Translated: */
$_LANG['telesignverificationcanceled'] = "電話確認サービスに一時的な問題があり、電話確認がキャンセルされました。";
...
Translated: */
$_LANG['telesignverificationproblem'] = "電話確認サービスに問題があり、注文を確認できませんでした。 後でもう一度やり直してください。";

/* Original: 
$_LANG['telesignverify'] = "Your phone number %s needs to be verified to complete the order.";
Translated: */
$_LANG['telesignverify'] = "注文を完了するには、あなたの電話番号 %s を確認する必要があります。";

/* Original: 
$_LANG['ticketratingexcellent'] = "Excellent";
Translated: */
$_LANG['ticketratingexcellent'] = "優秀な";
...
Translated: */
$_LANG['ticketratingquestion'] = "この回答をどのように評価しますか？";
...
Translated: */
$_LANG['transferdomaindesc'] = "あなたのドメインをこちらに移しますか？ その場合は、下にドメインを入力してください。";

/* Original: 
$_LANG['transferdomainname'] = "Transfer a Domain Name";
Translated: */
$_LANG['transferdomainname'] = "ドメイン名を移管する";

/* Original: 
$_LANG['updatecart'] = "Update Cart";
Translated: */
$_LANG['updatecart'] = "カートの更新";

/* Original: 
$_LANG['upgradechooseconfigoptions'] = "Upgrade/Downgrade the configurable options on this product.";
Translated: */
$_LANG['upgradechooseconfigoptions'] = "この製品の設定可能なオプションをアップグレードまたはダウングレードします。";
...
Translated: */
$_LANG['upgradechoosepackage'] = "以下のオプションから現在のパッケージをアップグレード/ダウングレードするパッケージを選択してください。";
...
Translated: */
$_LANG['upgradedowngradeconfigoptions'] = "アップグレード/ダウングレードのオプション";

/* Original: 
$_LANG['upgradenewconfig'] = "New Configuration";
Translated: */
$_LANG['upgradenewconfig'] = "新しい設定";
...
Translated: */
$_LANG['upgradesummary'] = "以下はアップグレードの注文の概要です。";
...
Translated: */
$_LANG['varilogixfraudcall_callnow'] = "今すぐ電話！";
...
Translated: */
$_LANG['varilogixfraudcall_description'] = "不正防止対策の一環として、アカウントに登録されている電話番号に電話をかけて、上記のPINコードの入力を求めます。 PINコードを書き留めて、電話をかける準備が整ったら、下のボタンをクリックしてください。";
...
Translated: */
$_LANG['varilogixfraudcall_error'] = "エラーが発生しました。注文を確認するためにあなたの番号へ電話をかけることができませんでした。 ご注文を完了するためにできるだけ早くサポート部門に連絡してください。";
...
Translated: */
$_LANG['varilogixfraudcall_fail'] = "注文を確認するための電話が失敗しました。 これは、あなたの電話番号が間違って入力されたか、または当社のシステムでブラックリストに載っていたためと考えられます。 ご注文を完了するためにできるだけ早くサポート部門に連絡してください。";
...
Translated: */
$_LANG['welcomeback'] = "お帰りなさい";

/* Original: 
$_LANG['whoisresults'] = "WHOIS Results for";
Translated: */
$_LANG['whoisresults'] = "WHOISの検索結果";
...
Translated: */
$_LANG['pwresetdesc'] = "パスワードを忘れた場合は、ここでリセットできます。 あなたの登録された電子メールアドレスを記入すると（設定されている場合、アカウントのセキュリティに関する質問に回答する）、パスワードをリセットする方法についての指示が送られてきます。";
...
Translated: */
$_LANG['pwresetemailnotfound'] = "入力したメールアドレスを持つクライアントアカウントは見つかりませんでした";
...
Translated: */
$_LANG['pwresetsecurityquestionrequired'] = "アカウントにセキュリティ保護用の質問が設定されているので、以下にこの質問に対する回答を入力する必要があります。";
...
Translated: */
$_LANG['pwresetsecurityquestionincorrect'] = "入力したセキュリティ保護用の質問の回答が、アカウントに設定されている回答と一致しません";
...
Translated: */
$_LANG['pwresetvalidationsent'] = "確認メール送信";
...
Translated: */
$_LANG['pwresetvalidationcheckemail'] = "パスワードリセットプロセスが開始されました。 次に何をするかについては、電子メールをチェックしてください。";

/* Original: 
$_LANG['pwresetkeyinvalid'] = "The reset link you have followed is invalid. Please try again.";
Translated: */
$_LANG['pwresetkeyinvalid'] = "リセットリンクは無効です。 もう一度やり直してください。";

/* Original: 
$_LANG['pwresetkeyexpired'] = "The reset link you have followed has expired. Please try again.";
Translated: */
$_LANG['pwresetkeyexpired'] = "リセットリンクは期限切れです。 もう一度やり直してください。";

/* Original: 
$_LANG['pwresetvalidationsuccess'] = "Password Reset Successful";
Translated: */
$_LANG['pwresetvalidationsuccess'] = "パスワードリセット成功";
...
Translated: */
$_LANG['overagestotaldiskusage'] = "ディスク使用量";

/* Original: 
$_LANG['overagestotalbwusage'] = "Total Bandwidth Usage";
Translated: */
$_LANG['overagestotalbwusage'] = "帯域使用量";
...
Translated: */
$_LANG['configoptionqtyminmax'] = "%s の最小要件は %s 最大要件は %s です";


/* Original: 
$_LANG['creditcardnostore'] = "Tick this box if you do NOT want us to store your credit card details for recurring billing";
Translated: */
$_LANG['creditcardnostore'] = "定期請求のためにクレジットカード情報を保存したくない場合は、このボックスにチェックを入れてください";
...
Translated: */
$_LANG['creditcarddeleteconfirmation'] = "保存されているクレジットカードの詳細がアカウントから削除されました";

/* Original: 
$_LANG['creditcardupdatenotpossible'] = "Credit Card Details cannot be updated at the current time. Please try again later.";
Translated: */
$_LANG['creditcardupdatenotpossible'] = "クレジットカードの詳細は現在更新できません。 後でもう一度やり直してください。";
...
Translated: */
$_LANG['promoappliedbutnodiscount'] = "入力したプロモーションコードはカートに適用されていますが、割引の対象となる商品はまだありません - プロモーション条件を確認してください";
...
Translated: */
$_LANG['upgradeerroroverdueinvoice'] = "次の更新のために請求書がすでに生成されているため、現在この製品をアップグレードまたはダウングレードすることはできません。<br /><br />続行するには、最初に未払いの請求書をお支払いください。その後すぐにアップグレードまたはダウングレードすることができ、差額を請求されるか、または必要に応じて請求されます。";
...
Translated: */
$_LANG['upgradeexistingupgradeinvoice'] = "アップグレードまたはダウングレードはすでに進行中のため、現在この製品をアップグレードまたはダウングレードすることはできません。<br /><br />続行するには、最初に未払いの請求書をお支払いください。その後すぐにアップグレードまたはダウングレードすることができ、差額を請求されるか、または必要に応じて請求されます。<br/><br/>誤ってこのメッセージを受け取っていると思われる場合は、トラブルチケットを送信してください。";
...
Translated: */
$_LANG['orderpaymentterm36month'] = "36ヶ月価格";
...
Translated: */
$_LANG['invoicespartialpayments'] = "分割支払い";
...
Translated: */
$_LANG['masspaydescription'] = "以下は、選択された請求書とそれらすべてに対する支払いの合計額の概要です。 支払いを送信するには、下記のお支払い方法を選択して送信してください。";
...
Translated: */
$_LANG['searchenterdomain'] = "検索するドメインを入力";

/* Original: 
$_LANG['searchfilter'] = "Filter";
Translated: */
$_LANG['searchfilter'] = "フィルタ";
...
Translated: */
$_LANG['vpsnetnetworkgraphs'] = "Networkグラフ";

/* Original: 
$_LANG['vpsnethourly'] = "Hourly";
Translated: */
$_LANG['vpsnethourly'] = "毎時";
...
Translated: */
$_LANG['twitterlatesttweets'] = "最新ツイート";
...
Translated: */
$_LANG['twitterfollowus'] = "フォローする";

/* Original: 
$_LANG['twitterfollowuswhy'] = "to stay up to date with our latest news &amp; offers";
Translated: */
$_LANG['twitterfollowuswhy'] = "最新のニュースやオファーを常に最新の状態に保つため";
...
Translated: */
$_LANG['domainreleasedescription'] = "新しいTAGをここに入力してドメイン名を別のレジストラに移動してください。";

/* Original: 
$_LANG['domainreleasetag'] = "New Registrar Tag";
Translated: */
$_LANG['domainreleasetag'] = "新しいレジストラTAG";
...
Translated: */
$_LANG['ordersummarybegin'] = "開始する商品を選択してください";
...
Translated: */
$_LANG['ordererrorsoccurred'] = "次のエラーが発生したため、チェックアウトする前に修正する必要があります。";
...
Translated: */
$_LANG['ordertostickconfirm'] = "同意することを確認するためにチェックを入れてください";
...
Translated: */
$_LANG['cartexistingcustomer'] = "私は既存のお客様です";
...
Translated: */
$_LANG['dlinvalidlink'] = "無効なリンクです。 サポートに連絡してください";


/* Original: 
$_LANG['domaindnsmanagementlaunch'] = "Launch DNS Manager";
Translated: */
$_LANG['domaindnsmanagementlaunch'] = "DNS管理を起動する";

/* Original: 
$_LANG['domainemailforwardinglaunch'] = "Launch Mail Forwarding Manager";
Translated: */
$_LANG['domainemailforwardinglaunch'] = "メール転送管理を起動する";
...
Translated: */
$_LANG['domaindnsmxonly'] = "MX専用の優先レコード";
...
Translated: */
$_LANG['noquotes'] = "現在アカウントに保存されている見積もりはありません。<br />見積もりをリクエストするには、チケットを開いてください。";
...
Translated: */
$_LANG['quotestageonhold'] = "保留";

/* Original: 
$_LANG['quotestageaccepted'] = "Accepted";
Translated: */
$_LANG['quotestageaccepted'] = "受け入れ済み";
...
Translated: */
$_LANG['invoicepaymentpendingreview'] = "ありがとうございました！ 支払いは成功し、2CheckOutのレビュープロセスが完了するとすぐに請求書に適用されます。<br /><br />これには数時間かかることがあるのでお待ちください。";
...
Translated: */
$_LANG['cartdomainexists'] = "このドメインはすでにデータベースに存在しているため、再度注文することはできません";
...
Translated: */
$_LANG['cartregisterhowlong'] = "どれくらいの期間これを登録しますか？";
...
Translated: */
$_LANG['carttransferpossible'] = "おめでとうございます、 %s を %s に転送することができます";
...
Translated: */
$_LANG['cartdomainsconfiginfo'] = "選択したドメインでは、次のオプションと設定が利用可能です。 必須フィールドは*で示されています。";
...
Translated: */
$_LANG['cartfollowingaddonsavailable'] = "次のアドオンはあなたのアクティブな製品とサービスに利用可能です。";
...
Translated: */
$_LANG['cartsubdomainchoice'] = " %sのサブドメインを使用";
...
Translated: */
$_LANG['orderForm']['authCodeTooltip'] = "移転を開始するには、現在のレジストラ（ドメインの管理会社）から認証コードを取得してください。 これらは、epp CodeまたはAuth Code（オースコード） と呼ばれることがあります。 それらはパスワードの役割を果たし、ドメイン名固有のものです。";
