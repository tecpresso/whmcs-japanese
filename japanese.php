...
$_LANG['orderpromovalidatebutton'] = "クーポンコードを適用";
$_LANG['orderPromoCodePlaceholder'] = "お持ちのクーポンコードを入力してください";
...
$_LANG['orderForm']['applyPromoCode'] = "クーポンコードを適用";
