...
$_LANG['domaineppcode'] = "Auth Code (EPP Code)";
$_LANG['domaineppcodedesc'] = "この情報は現在の登録業者からのみ取得できます";
$_LANG['domaineppcoderequired'] = "次のドメインのAuth Codeを入力してください：";
...
$_LANG['carttransferdomainchoice'] = "お持ちのドメインを移管";
...
$_LANG['navtransferdomain'] = "お持ちのドメインを移管";
...
$_LANG['clientareahomelogin'] = "すでにアカウントをお持ちの場合は、以下のボタンからアカウントページへログインして頂けます。";
...
$_LANG['orderForm']['authCodePlaceholder'] = "Auth Code (EPP Code)";
